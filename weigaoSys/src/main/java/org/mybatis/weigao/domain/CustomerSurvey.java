...
public class CustomerSurvey implements Serializable {
    ...
    private String custFeedBack; //客户评价
    private String chargeLimit; //回款期限
    private String openDt;//开业时间
    private String custCoopType; //合作类别
    ...
    public String getCustCoopType() {
        return custCoopType;
    }

    public void setCustCoopType(String custCoopType) {
        this.custCoopType = custCoopType;
    }
    ...
    public boolean isVerifyCustomer() {
        return verifyCustomer;
    }

    public void setVerifyCustomer(boolean verifyCustomer) {
