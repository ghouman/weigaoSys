    ...
    public UserDetails loadUserByUsername(String username)
        ...
        /* //加载spring的配置文件
           ...
           //得到在mybatis的*Mapper.xml文件中配置好的Mapper节点
            ...
            sysUserList =  mapper.getSysUserByUid(username);*/
...
/*    public SysUser loadSysUserByUid(String uid) {
    ...
    public static void main(String[] args) throws IOException {
           ...
           List<SysUser> sysUser = (List<SysUser>) mapper.getSysUserByUid("cj@wgbp.net");

        ses.close();
           //打印输出
           System.out.println(sysUser.get(0).getUserName());
       }
}
