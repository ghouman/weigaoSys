...
<div class="container">
    ...
    <stripes:form beanclass="org.mybatis.weigao.web.actions.CustomerActionBean" class="form-inline">
        ...
        <table class="table-condensed">
            <tr>
                ...
                <td><label for="custVal">客户类型:</label></td>
                <td>
                    <stripes:select name="customer.custVal" id="custVal" style="width:150px">
                        <stripes:option value="">全部</stripes:option>
    ...
    <display:table id="row" defaultsort="1" pagesize="15" sort="external" name="actionBean.paginatedList"
        ...
        <display:column property="coop_DT" title="执业许可证" style="width:10%"/>
