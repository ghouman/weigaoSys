...
<table class="table table-bordered">
    <tr>
        ...
        <td width="25%"><input type="text" name="customer.zect" class="form-control" id="zect"
                               value="${actionBean.customer.zect}" readonly="readonly">
        ...
        <td>
            <input type="text" name="customer.coop_DT" value="${actionBean.customer.coop_DT}"
                   class="form-control" id="coop_DT" readonly="readonly">
        </td>
    ...
    <tr>
        ...
        <th>合作类别：</th>
        <td>
            <stripes:select name="customer.coopType" value="${actionBean.customer.coopType}"
                            class="form-control" id="coopType">
                <stripes:option value="分销">分销</stripes:option>
                <stripes:option value="直销">直销</stripes:option>
                <stripes:option value="三产">三产</stripes:option>
                <stripes:option value="托管">托管</stripes:option>
                <stripes:option value="投放">投放</stripes:option>
                <stripes:option value="其他">其他</stripes:option>
            </stripes:select>
        </td>
    </tr>
    <tr>
        <th>回款期限：</th>
        <td><stripes:text name="customer.chargeLimit" maxlength="50" value="${actionBean.customer.chargeLimit}"
                          class="form-control" id="chargeLimit"/></td>
        <th>开业时间：</th>
        <td><stripes:text name="customer.openDt" maxlength="20" value="${actionBean.customer.openDt}"
                          class="form-control" id="openDt"/></td>
        <th>客户评价：</th>
        <td>
            <stripes:select name="customer.feedback" value="${actionBean.customer.feedback}"
