...
<div class="container">
    ...
    <display:table name="actionBean.paginatedList" id="row"
        ...
        <display:column property="surveyNo" title="调研编号" style="width:10%"/>
        <display:column property="customer" sortable="false" sortName="customer" title="客户名称" style="width:25%"/>
        <display:column property="checked" title="提交" paramId="checked" style="width:6%"/>
        <display:column property="submit" title="初审" paramId="submit" style="width:6%"/>
        <display:column property="verify" title="复审" style="width:6%"/>
        <display:column title="调研日期" style="width:10%"> <c:out value='${fn:substring(row.surveyDate, 0, 10)}'/></display:column>
        <display:column property="preparer" sortable="false" sortName="preparer" title="负责专员" style="width:10%"/>
