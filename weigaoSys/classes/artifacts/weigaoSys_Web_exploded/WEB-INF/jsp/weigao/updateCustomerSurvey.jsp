...
<table class="table table-bordered">
    <tr>
        <th width="80">客户名称：</th>
        <td id="customer" width="25%">${actionBean.customerSurvey.customer}</td>
        <th width="105">组织机构代码：</th>
        <td id="zect" width="25%">${actionBean.customerSurvey.zect}</td>
        <th>执业许可证：</th>
        <td id="coop_DT">${actionBean.customerSurvey.coop_DT}</td>

    </tr>
    <tr>
        <th>负责专员：</th>
        <td id="clerk">${actionBean.customerSurvey.clerk}</td>
        <th>销售大区：</th>
        <td id="salesRegion">${actionBean.customerSurvey.salesRegion}</td>
        <th width="80">大区经理：</th>
        <td id="manager">${actionBean.customerSurvey.manager}</td>


    </tr>
    <tr>
        <th>客户地址：</th>
        <td id="address">${actionBean.customerSurvey.address}</td>
        <th>邮编：</th>
        <td id="postalCode">${actionBean.customerSurvey.postalCode}</td>
        <th width="80">区域主管：</th>
        <td id="preparerManager">${actionBean.customerSurvey.preparerManager}</td>
    </tr>
    <tr>
        <th width="80">客户网址：</th>
        <td id="webSite">
        ...
        <th>所在城市：</th>
        <td id="port">${actionBean.customerSurvey.port}</td>
        <th>所属省份：</th>
        <td id="province">${actionBean.customerSurvey.province}</td>


    </tr>
    <tr>
        <th width="80">医院等级：</th>
        <td id="healthClass">${actionBean.customerSurvey.healthClass}</td>
        <th width="80">行政级别：</th>
        <td id="hierarchy">${actionBean.customerSurvey.hierarchy}</td>
        <th width="80">客户类型：</th>
        <td id="custVal" width="215">${actionBean.customerSurvey.custVal}</td>


    </tr>
    <tr>
        <th>所属科室：</th>
        <td id="labOffice">${actionBean.customerSurvey.labOffice}</td>
        <th>血透室电话：</th>
        <td id="labTel">${actionBean.customerSurvey.labTel}</td>
        <th>合作类别：</th>
        <td>
                ${actionBean.customerSurvey.custCoopType}
        </td>
    </tr>
    <tr>
        <th>回款期限：</th>
        <td>${actionBean.customerSurvey.chargeLimit}</td>
        <th>开业时间：</th>
        <td>${actionBean.customerSurvey.openDt}</td>
        <th>客户评价：</th>
        <td>
                ${actionBean.customerSurvey.custFeedBack}
        </td>
    </tr>
    <tr>
        <th>医院信息</th>
