...
function initCustomer(jsonObj) {
    ...
    $('#custCoopType').append(jsonObj.coopType);
    $('#chargeLimit').append(jsonObj.chargeLimit);
    $('#openDt').append(jsonObj.openDt);
    $('#custFeedBack').append(jsonObj.feedback);

    //$('#verify').append(jsonObj.verify);
