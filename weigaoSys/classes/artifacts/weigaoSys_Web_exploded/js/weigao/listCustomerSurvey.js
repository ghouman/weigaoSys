...
function bindModal(uid, surveyNo, operate, isUpdate) {
    $('#operateModal').on('show', function (e) {
        $("#dosubmit").die().live("click",function (e) {
        ...
        success: function (obj) {
            ...
            $(customerList).each(function () {
                ...
                tbody_customer = tbody_customer + '<tr><td><input type="hidden" id="uid" value="' + that.uid + '">' +
                    ...
                    '<input type="hidden" id="custCoopType" value="' + that.coopType + '">' +
                    '<input type="hidden" id="chargeLimit" value="' + that.chargeLimit + '">' +
                    '<input type="hidden" id="openDt" value="' + that.openDt + '">' +
                    '<input type="hidden" id="custFeedBack" value="' + that.feedback + '">' +
